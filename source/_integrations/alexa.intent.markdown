...
- Scroll down again hit the tab called `Configuration' and on the left you will find `Environment variables`, click on `Edit` button and add the following environment variables as needed:
